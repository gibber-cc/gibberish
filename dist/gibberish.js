...
module.exports = function( Gibberish ) {
  ...
  let factory = function( graph, name, defaults, props ) {
    ...
    console.log( ugen.inputNames, Gibberish.genish.gen.parameters )
