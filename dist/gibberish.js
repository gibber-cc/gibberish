  ...
  createScriptProcessor() {
    ...
    this.node.onaudioprocess = function( audioProcessingEvent ) {
      ...
      for (let sample = 0; sample < left.length; sample++) {
        ...
        let out = callback.apply( null, gibberish.callbackUgens )//callback( ...gibberish.callbackUgens )

        //if( sample === 0 ) console.log( out )
...
},{"./binops.js":70,"./bus.js":71,"./oscillators.js":73,"./ugenTemplate.js":74,"genish.js":35,"memory-helper":75}],73:[function(require,module,exports){
let g = require( 'genish.js' )
...
},{"genish.js":35}],74:[function(require,module,exports){
module.exports = function( Gibberish ) {
