...
},{"./ad.js":79,"./adsr.js":80,"./ramp.js":82}],82:[function(require,module,exports){
...
module.exports = function (Gibberish) {
  ...
  const Reverb = inputProps => {
    ...
    {
      'use jsdsp';
      const summedInput = genish.eq(isStereo, true) ? genish.add(input[0], input[1]) : input;
      ...
      // const left  = g.mix( isStereo ? input[0] : input, mix1, drywet )
      // const right = g.mix( isStereo ? input[1] : input, mix1, drywet )
