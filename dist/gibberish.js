...
module.exports = function( Gibberish ) {
  ...
  let Synth = inputProps => {
    ...
    let oscWithGain = g.mul( g.mul( osc, env, velocity ), g.in( 'gain' ) ),
        panner
