      ...
      Object.defineProperty( synth, property, {
        ...
        set( v ) {
          ...
          for( let child of synth.voices ) {
            ...
            if( isNaN( child ) ) {
              console.log( 'setting:', property, v )
              child[ property ] = v
            }
          }
        }
